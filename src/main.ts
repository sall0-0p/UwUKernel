...
// const code1 = "_G.counter = 0; print('Hello from main thread!'); while true do _G.counter = _G.counter + 1 end";
// const process1 = pm.createProcess("/", code1);
//
// const code2 = "print('Hello from second thread!'); while true do term.setCursorPos(1, 2) term.write(_G.counter) end";
...
// const thread4 = pm.createThread(code4, process1);
